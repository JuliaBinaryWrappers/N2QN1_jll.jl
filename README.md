# `N2QN1_jll.jl` (v4.0.0+0)

[![deps](https://juliahub.com/docs/N2QN1_jll/deps.svg)](https://juliahub.com/ui/Packages/General/N2QN1_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/c61377640d9ad0f9d457d3ad54c57315f3b5c144/N/N2QN1/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `N2QN1_jll.jl` have been built from these sources:

* git repository: https://gitlab.inria.fr/fuentes/n2qn1.git (revision: `a3b6c2cf8d429591976f5e33c0c9766b1e8fea05`)

## Platforms

`N2QN1_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `N2QN1_jll.jl`:
...
* `LibraryProduct`: `libn2qn1`
* `LibraryProduct`: `libn2qn1r`
